...
public class Skalowanie implements Transformacja {
    ...
    /*
 * W przypadku klasy Skalowanie metoda getTranformacjaOdwrotna
 * zgłasza błąd w przypadku braku tranformacji odwrotnej
 ...
 * obsługujący wyrzucony wyjątek
    ...
    public Transformacja getTranformacjaOdwrotna() throws
        ...
        if (skalaX == 0 || skalaY == 0)
            ...
            "Brak tranformacji odwrotnej. Przynajmniej jeden z czynników skalowania jest równy 0.");
